...
- [ ] auth
  - [ ] 회원가입을 할 수 있어야 한다.
    - [ ] 비밀번호는 해시로 저장되어야 한다.
    - [ ] 아이디는 이메일로 진행하고, 중복 가입은 허용되지 않는다.
  - [ ] 로그인을 할 수 있어야 한다.

- [ ] show
  - [ ] 특정 공연에 대해 티켓 종류와 최대 판매 수량을 설정할 수 있어야 한다.
...
- [ ] reservation
  - [ ] 한 사람 당 최대 4장의 티켓을 예매할 수 있다.
  - [ ] 동시에 예약을 진행할 때, oversell이 되어서는 안된다.
  - [ ] 재고가 0이면 예약은 실패해야 한다.
  - [ ] 동시에 수 천, 수 만명이 몰릴 때 모든 기능들이 정상 동작해야 한다. (예약 외 다른 기능들도 포함)
  - [ ] 
